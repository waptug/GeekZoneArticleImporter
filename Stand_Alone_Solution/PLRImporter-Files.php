...
Add a way to grab stock photos automaticly as the article is being parsed from the category and make sure the same image doesent get used again.
...
//@TODO add a ui for selecting the base interactively or create a way to upload to a folder by dragging in a folder of articles.
...
define('BASE_ARTICLE_PATH','/home3/mygee4dx/leadspidea.com/plr/100000articles-PLR-articles/Affiliate_Programs/');
//define('TARGET_FILE', '7_Benefits_Of_Building_Niche_Blogs.txt');//
// echo file_get_contents(MY_WP_PATH . TARGET_FILE);
//echo "<br>";
echo "BASE Path=:".BASE_ARTICLE_PATH;
...
$articleToImport=$post_date.'|'.$userID.'|'.$Title.'|'.$Summary.'|'.$ArticleBodyMaster.'|'.'';//concatenates article sections into one varible so the wppost function can explode it into the correct parts.
...
//Modified article import to blog post function
...
define('MY_WP_PATH', '/home3/mygee4dx/leadspidea.com/');
